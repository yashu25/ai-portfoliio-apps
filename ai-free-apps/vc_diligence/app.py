            ...
            try:
                ...
                with st.spinner(f"Running due diligence on {startup_name}..."):
                    with requests.post(
                        ...
                        headers={"Authorization": f"Bearer {api_key}", "Content-Type": "application/json", "HTTP-Referer": "https://yashconsultsagentically.streamlit.app", "X-Title": "AI VC Due Diligence"},
