...
# ── AUTO-FALLBACK LLM (handles 429 rate limits automatically) ──
FALLBACK_MODELS = [
...
.page-title { font-family: 'Playfair Display', serif; font-size: 2.6rem; font-weight: 800; color: #1a1a2e; line-height: 1.15; margin-bottom: 10px; letter-spacing: -0.5px; }
...
.stSelectbox > div > div { background: white !important; border: 1.5px solid #e2ddd5 !important; border-radius: 10px !important; color: #1a1a2e !important; font-family: 'Plus Jakarta Sans', sans-serif !important; font-size: 0.88rem !important; box-shadow: 0 1px 4px rgba(0,0,0,0.05) !important; }
...
.stButton > button:hover { background: #2d2d50 !important; box-shadow: 0 6px 22px rgba(26,26,46,0.32) !important; transform: translateY(-1px) !important; }
.output-empty { background: white; border: 1.5px dashed #ddd8d0; border-radius: 16px; padding: 52px 36px; text-align: center; }
.output-empty .icon { font-size: 2.8rem; margin-bottom: 14px; }
.output-empty h3 { font-family: 'Playfair Display', serif; font-size: 1.25rem; color: #6b6b80; font-weight: 700; margin-bottom: 8px; }
.output-empty p { font-size: 0.85rem; color: #9ca3af; line-height: 1.7; margin-bottom: 18px; }
.output-tag { display: inline-block; background: #f3f0ff; color: #7c3aed; font-family: 'JetBrains Mono', monospace; font-size: 0.65rem; padding: 4px 11px; border-radius: 6px; margin: 3px; }
.output-card { background: white; border: 1.5px solid #e2ddd5; border-radius: 16px; padding: 32px 36px; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 0.92rem; line-height: 1.85; color: #374151; box-shadow: 0 4px 24px rgba(0,0,0,0.07); }
.stDownloadButton > button { background: white !important; color: #374151 !important; border: 1.5px solid #e2ddd5 !important; border-radius: 10px !important; font-family: 'Plus Jakarta Sans', sans-serif !important; font-size: 0.82rem !important; font-weight: 500 !important; width: 100% !important; margin-top: 14px !important; box-shadow: none !important; }
.stDownloadButton > button:hover { border-color: #7c3aed !important; color: #7c3aed !important; }
.page-footer { margin-top: 48px; padding-top: 20px; border-top: 1px solid #e2ddd5; font-family: 'JetBrains Mono', monospace; font-size: 0.65rem; color: #c5c0ba; letter-spacing: 0.5px; }
</style>
...
with st.sidebar:
    ...
    Free tier limits<br>20 requests / minute<br>200 requests / day
    </div>""", unsafe_allow_html=True)
